...
void main() {
  ...
  group('KeystrokeHomePage', () {
    ...
    testWidgets('tests and persists a normalized backend URL and YAMNet', (
      tester,
    ) async {
      ...
      await tester.tap(find.byKey(const ValueKey<String>('method-dropdown')));
      await tester.pumpAndSettle();
      await tester.tap(find.text('YAMNet').last);
      await tester.pumpAndSettle();
      ...
      expect(find.text('YAMNet'), findsOneWidget);
    });
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(backend.analyzedMethods, <String>['yamnet']);
        ...
        expect(history.single.method, 'yamnet');
