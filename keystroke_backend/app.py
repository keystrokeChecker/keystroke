...
from src.predictor import predict_keystroke_counts, predict_keystroke_counts_ml, predict_keystroke_counts_rule
from src.yamnet_config import CLASSIFIER_THRESHOLD, SENSITIVITY_DELTA, GAP_THRESHOLD_ML, GAP_THRESHOLD_RULE, MERGE_GAP_SECONDS
...
async def analyze(
    ...
    gap_threshold: float | None = Form(None),
    ...
    try:
        ...
        if method == "rule":
            counts = predict_keystroke_counts_rule(
                wav_path,
                delta=delta,
            ...
            counts = predict_keystroke_counts_ml(
                wav_path,
                delta=delta,
                gap_threshold=gap_threshold,
                merge_gap_seconds=merge_gap_seconds,
